...
"""
Codigo para leer palabras de un archivo y validar su frecuencia
"""
import time
import sys
...
def read_words_from_file(filename):
    """
    Codigo para leer las palabras  del archivo y su frecuencia
    """
    word_count = {}
    errors = []
    try:
...
def write_results_to_file(results):
    """
    Codigo para escribir las palabras y sus frecuencias en un archivo
    """
